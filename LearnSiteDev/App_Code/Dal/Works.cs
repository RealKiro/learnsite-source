	...
	public class Works
	{
       ...
       /// <returns></returns>
        ...
        public int AddWorkUp(LearnSite.Model.Works model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into Works(");
            strSql.Append("Wnum,Wcid,Wmid,Wmsort,Wfilename,Wtype,Wurl,Wlength,Wdate,Wip,Wtime,Wegg,Wgrade,Wterm,Woffice,Wflash,Wsid,Wclass,Wname,Wyear,Wthumbnail,Wtitle,Wcode,Wdict,Wlid)");
            strSql.Append(" values (");
            strSql.Append("@Wnum,@Wcid,@Wmid,@Wmsort,@Wfilename,@Wtype,@Wurl,@Wlength,@Wdate,@Wip,@Wtime,@Wegg,@Wgrade,@Wterm,@Woffice,@Wflash,@Wsid,@Wclass,@Wname,@Wyear,@Wthumbnail,@Wtitle,@Wcode,@Wdict,@Wlid)");
            strSql.Append(";select @@IDENTITY");
            SqlParameter[] parameters = {
